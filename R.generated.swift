...
struct _R {
  ...
  struct nib {
    ...
    func validate() throws {
      ...
      if UIKit.UIImage(named: "Playtube_text", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'Playtube_text' is used in nib 'HomeHeaderAndCategoryCell', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "fi_search", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'fi_search' is used in nib 'HomeHeaderAndCategoryCell', but couldn't be loaded.") }
      ...
      if UIKit.UIImage(named: "splash", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'splash' is used in nib 'HomeHeaderAndCategoryCell', but couldn't be loaded.") }
